...
----------------------------------------------------------------------->
<cfcomponent name="DataProxy" output="false" extends="coldbox.system.remote.ColdboxProxy">
	...
	<cffunction name="initializeDataLoadProcess" output="false" returnType="boolean" returnFormat="plain" access="remote">

		<cfset arguments.event = "usaspending.initializeDataLoadProcess"/>

		<cfreturn super.process(argumentCollection = arguments)/>

	</cffunction>

	<cffunction name="getDataSetAJAX" output="false" returnType="any" returnFormat="plain" access="remote">
		<cfargument name="intRecordsFrom" type="numeric" default="1"/>

		<cfset arguments.event = "usaspending.getDataSet"/>
